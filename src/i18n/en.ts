// English texts — extracted from config.ts
export const en = {
  meta: {
  ...
  trust: {
    label: "Recognition",
    heading: "Why Families Trust Veronica",
    yelp: {
  ...
  press: {
    ...
    articles: [
      ...
      {
        title: "Soy Una Doula Hoy! — Featured on Noticiero Univision 34 LA",
        excerpt:
          "Veronica Hinojosa-Stang was featured on Noticiero Univision 34 Los Angeles in a segment highlighting her work as a doula and baby nurse, bringing visibility to the vital role of postpartum care professionals in the Latino community.",
      },
    ],
  },
  ...
  certifications: {
    label: "Credentials",
    heading: "42+ Certifications",
  },

  footer: {
    cta: "Ready to start your journey?",
    ctaSub: "Let Veronica guide you through one of life's most beautiful chapters.",
    emailBtn: "Email Veronica",
